...
using S2G2_SISAPP.Models;

namespace S2G2_SISAPP.Controllers
{
    public class TeachingAssignmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.InstuctorID = new SelectList(db.Instructors, "InstructorID", "InstructorFirstName");
        ...
        public ActionResult Create([Bind(Include = "CourseID,InstuctorID,TermID")] TeachingAssignment teachingAssignment)
        {
            ...
            ViewBag.InstuctorID = new SelectList(db.Instructors, "InstructorID", "InstructorFirstName", teachingAssignment.InstuctorID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,InstuctorID,TermID")] TeachingAssignment teachingAssignment)
        {
            if (ModelState.IsValid)
            {
